...
<div class="main">
  ...
  <tr align="left" valign="top">
    <td width="27%"><img src="../slideshow/slide_images/pic6.jpg" width="149" height="102" alt="brand" class="img_b" /></td>
    <td width="73%"><p><span>Large Format Displays</span><br/>
   
    Rainbow Printographics is offering a unique range of Large format display services. 

We develop content for:<br/>

<li>Animated Product promotions</li>
<li>Animated Company Corporate Profiles</li>
<li>Event promotions</li>
<li>Movie Adverising</li>
<li>Social Awareness Promotions</li>
<li>Touch Screen Applications</li>
<li>E-learning</li></p></td>
  </tr>
