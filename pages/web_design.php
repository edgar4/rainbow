...
<div class="main">
 ...
 <?php include("../includes/sub_links.php");?>
  ...
  <tr align="left" valign="top">
    <td width="27%"><img src="../images/relatedpostsslideouts.jpg"" width="149" height="102" alt="brand" class="img_b" /></td>
    <td width="73%"><p><span>Web design</span><br/>
   
   We are ready to discover your on-line presence which is both visually pleasing and encouraging your visitors to connect with you.

Anyone can design a simple website but few can discover one that brings in a high return on your on-line investment.Your business image should be strong enough to sell your services and/or products as efficiently and professionally as possible:</p></td>
  </tr>
